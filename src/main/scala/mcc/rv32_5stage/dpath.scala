...
class DatToCtlIo(implicit val conf: MccCoreParams) extends Bundle()
{
...
// Reference monolithic implementation kept for comparison
class DatPath_Ref(implicit val p: Parameters, val conf: MccCoreParams) extends Module
{
